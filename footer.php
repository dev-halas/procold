		...
		<div class="footerWrapper">
			<div class="footerCompany">
				...
				<div class="footerCol--text">
					<p>
						<b>ProCOLD s.c. A.Stasik,M.Szymczak</b><br/>
						ul. Leszczyce 10, 63-200 Jarocin
					</p>

					<p>
						NIP: 617 220 48 61, <br/>
						REGON: 302722478
					</p>

					<p>
						Nasze produkty, świetnie odnajdują się tam, gdzie wymagana jest ochrona przed zamarzaniem, korozją i powstawaniem osadów.
					</p>

					<a href="#">Polityka ochrony danych RODO</a>
					<a href="#">Polityka jakości</a>
			...
			<div class="footerContact">
				...
				<div class="footerCol--contact">
					<div class="footerContact--col">
						<p>
							<b>SEKRETARIAT:</b><br/>
							tel: <a href="tel: +48 531 215 216" target="_blank">+48 531 215 216</a><br>
							mail: <a href="mailto: sekretariat@procold.pl" target="_blank">sekretariat@procold.pl</a>
						</p>
					...
					<div class="footerContact--col">
						...
						<p>
							<b>DYSTRYBUCJA:</b><br>
							tel: <a href="tel: +48 739 215 213" target="_blank">+48 739 215 213</a><br>
							tel: <a href="tel: +48 794 215 218" target="_blank">+48 794 215 218</a><br>
							mail: <a href="mailto: handel@procold.pl" target="_blank">handel@procold.pl</a>
						</p>
					</div>
				</div>
			</div>
			<div class="footerLogo">
				<img src="<?php echo THEME_URL;?>_dev/img/footer_logo.png" alt="procold_footer_logo">
				<div class="social_icons">
					...
					<a href="#" taget="_blank" class="instagram">
					...
					<a href="#" taget="_blank" class="youtube">
